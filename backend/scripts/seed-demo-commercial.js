...
async function insertCommercialPlan(client) {
  await client.query(`
    INSERT INTO planes_comerciales (
      ...
      reportes_avanzados, api_access, app_movil, rutas_campo, soporte, publico, activo, orden, metadata
    )
    VALUES ($1,$2,$3,$4,'USD',100,1,8,true,true,true,true,true,'prioritario',false,true,90,$5)
