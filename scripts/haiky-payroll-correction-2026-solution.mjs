...
const checks = [
  ...
  runCheck('backend_roles_focalizado', 'npm.cmd', [
    ...
    'manualAttendanceService.test.js',
...
writeUtf8(path.join(OUTPUT_DIR, 'CIERRE_GOBIERNO.md'), `${[
  ...
  '- Los roles cerrados permanecen inmutables por defecto; una reapertura controlada del periodo, con motivo y auditoria, los devuelve a borrador para correccion y recalculo.',
...
const lock = {
  ...
  decisions: [
    ...
    'Los roles cerrados o pagados no se modifican directamente; la reapertura controlada del periodo cerrado exige motivo, transaccion y auditoria.',
  ...
  runtimeChanges: [
    ...
    'Contratos y pruebas gobiernan la reapertura controlada y la exposicion de borradores.',
  ],
