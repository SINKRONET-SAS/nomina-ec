...
assert(app.includes("'/api/nomina/descartar-calculo'"), 'Backend debe exponer descarte controlado del calculo mensual.');
assert(app.includes("app.delete('/api/nomina/:id'"), 'Backend debe exponer eliminacion controlada de rol borrador.');
