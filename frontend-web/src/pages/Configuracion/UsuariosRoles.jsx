...
export default function UsuariosRoles() {
  ...
  const verificationMutation = useMutation({
    mutationFn: async (id) => (await authenticatedApi.post(`/usuarios/${id}/verificacion-email/reenviar`)).data,
    onSuccess: (data) => setMessage(data.message || 'Se envió un código nuevo de verificación.'),
  });
