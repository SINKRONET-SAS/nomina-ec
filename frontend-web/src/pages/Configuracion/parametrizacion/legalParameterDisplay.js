...
export function labelLegalParameter(key) {
  const labels = {
    ...
    jornada_horas_mensuales: 'Horas mensuales para valor hora',
    jornada_maxima_semanal: 'Jornada máxima semanal',
    horas_extra_limite_semanal: 'Horas extra: límite semanal',
    horas_extra_recargo_suplementaria: 'Horas extra: multiplicador suplementario',
    horas_extra_recargo_extraordinaria: 'Horas extra: multiplicador extraordinario',
