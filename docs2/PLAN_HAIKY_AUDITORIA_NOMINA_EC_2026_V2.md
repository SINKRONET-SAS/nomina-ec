...
| ANV2-01 | P0 | pending_approval | Diagnostico runtime: confirmar falsos positivos V1, leer servicios reales y clasificar brechas EMAIL/TZ/LEG. |
| ANV2-02 | P0 | pending_approval | Comunicaciones reales: SMTP/proveedor en env, readiness, fallback dev bloqueado en produccion, auditoria y pruebas. |
| ANV2-03 | P0 | pending_approval | Timezone Ecuador: helper unico America/Guayaquil, defaults web/mobile/API y pruebas borde de fin de mes. |
| ANV2-04 | P0 | pending_approval | Firmas legales: representante legal, trabajador, fecha/lugar, versiones de plantilla en roles, contratos y actas. |
| ANV2-05 | P1 | pending_approval | Frontend operativo: configuracion de correo, estado de timezone/documentos, bloqueos visibles y acciones de prueba. |
| ANV2-06 | P0 | pending_approval | QA, migraciones, rollback, pruebas backend/PWA/mobile, AuditLock y release gate. |
