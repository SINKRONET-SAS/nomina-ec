...
# Crear directorios de la app móvil
app_movil_dirs = [
    'app-movil/src',
...
for d in app_movil_dirs:
    os.makedirs(d, exist_ok=True)

print(f"✓ {len(app_movil_dirs)} directorios de la app móvil creados")

# Crear App.js de la app móvil
app_movil_js = '''// ============================================================
...
print("✓ App móvil creada")
 # Result 
✓ 3 directorios de la app móvil creados
✓ App móvil creada
