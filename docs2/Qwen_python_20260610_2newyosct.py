# Crear páginas de Documentos
contratos_generados = '''import React from 'react';
...
with open('frontend-web/src/pages/Documentos/ContratosGenerados.jsx', 'w') as f:
    f.write(contratos_generados)

actas_finiquito = '''import React from 'react';
import { useQuery } from '@tanstack/react-query';
import axios from 'axios';
import { FileText, Download } from 'lucide-react';
...
with open('frontend-web/src/pages/Documentos/ActasFiniquito.jsx', 'w') as f:
    f.write(actas_finiquito)

print("✓ Páginas de documentos creadas")
 # Result 
✓ Páginas de documentos creadas
