...
import os
os.makedirs('frontend-web/src/context', exist_ok=True)

with open('frontend-web/src/context/AuthContext.jsx', 'w') as f:
...
os.makedirs('frontend-web/src/components/Layout', exist_ok=True)
with open('frontend-web/src/components/Layout/Layout.jsx', 'w') as f:
    f.write(layout_jsx)

print("✓ Contexto de autenticación y Layout creados")
 # Result 
✓ Contexto de autenticación y Layout creados
